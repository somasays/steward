...
value inside the JSONB is a `MaskedSample`, and a mask leaves at least three
characters of its value unknown at any length ([D10](#13-key-design-decisions)),
so this table holds shapes and statistics rather than customer values (I6).
